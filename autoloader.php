 ...
 * * * * * * * * * * * * * * * * */
 ...
 spl_autoload_register( function ($name) {
	 static $files = array(
		...
		"NlpTools\Clustering\Hierarchical"=>"/clustering/hierarchical.php",
		"NlpTools\Clustering\MergeStrategies\HeapLinkage"=>"/clustering/merge_strategies/heap_linkage.php",
		"NlpTools\Clustering\MergeStrategies\MergeStrategy"=>"/clustering/merge_strategies/merge_strategy.php",
		"NlpTools\Clustering\MergeStrategies\SingleLink"=>"/clustering/merge_strategies/single_link.php",
		"NlpTools\Clustering\MergeStrategies\CompleteLink"=>"/clustering/merge_strategies/complete_link.php",
		"NlpTools\Clustering\MergeStrategies\GroupAverage"=>"/clustering/merge_strategies/group_average.php",
